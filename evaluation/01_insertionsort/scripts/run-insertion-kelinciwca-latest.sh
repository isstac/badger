...
# folder for runtime
target=/vol/home-vol2/se/nollerya/fuzzing/experiments/01-insertionsort-kelinciwca-latest
...
echo "Starting AFL.."
screen -S afl -d -m bash -c 'AFL_SKIP_CPUFREQ=1 AFL_I_DONT_CARE_ABOUT_MISSING_CRASHES=1 /vol/home-vol2/se/nollerya/fuzzing/afl-2.51b-latestWCA/afl-fuzz -i ./in_dir -o ./fuzzer-out -c jumps -S afl -t 999999999 /vol/home-vol2/se/nollerya/fuzzing/kelinciwca-latest/fuzzerside/interface @@'
