...
time_bound=18000 # = 5 hours

# number of iterations
number_of_runs=5 #5

# folder with sources
src=/vol/home-vol2/se/nollerya/fuzzing/memoise/issta-experiments/01-insertionsort

# folder for runtime
target=/vol/home-vol2/se/nollerya/fuzzing/experiments/01-insertionsort-kelinci

# kelinci=1, kelinci-spf=2
execution_mode=1

# server parameter
server_param="InsertionSort @@"
