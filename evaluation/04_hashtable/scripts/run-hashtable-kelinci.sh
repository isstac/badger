...
time_bound=100 #18000 #18000 = 5 hours

# number of iterations
number_of_runs=1 #10 #5

# folder with sources
src=/vol/home-vol2/se/nollerya/fuzzing/memoise/issta-experiments/04-hashtable

# folder for runtime
target=/vol/home-vol2/se/nollerya/fuzzing/experiments/04-hashtable-kelinci

# kelinci=1, kelinci-spf=2
execution_mode=1

# server parameter
server_param="HashTable @@"
...
echo "Starting AFL.."
screen -S afl -d -m bash -c 'AFL_SKIP_CPUFREQ=1 AFL_I_DONT_CARE_ABOUT_MISSING_CRASHES=1 /vol/home-vol2/se/nollerya/fuzzing/afl-2.51b-kelincipure/afl-fuzz -i ./in_dir -o ./fuzzer-out -c jumps -S afl -t 999999999 /vol/home-vol2/se/nollerya/fuzzing/kelinciwca/fuzzerside/interface @@'
