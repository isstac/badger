...
# folder with sources
src=/vol/home-vol2/se/nollerya/fuzzing/memoise/engagements/01_engagement1_image_processor

# folder for runtime
target=/vol/home-vol2/se/nollerya/fuzzing/experiments/06-imageprocessor-fullimage-kelinci

# kelinci=1, kelinci-spf=2
execution_mode=1

# server parameter
server_param="drivers.DriverKelinci @@"
