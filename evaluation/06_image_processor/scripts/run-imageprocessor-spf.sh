...
time_bound=120 #18000 #18000 # = 5 hours
...
# folder for runtime
target=/vol/home-vol2/se/nollerya/fuzzing/experiments/06-imageprocessor-fullimage-spf
...
do
  ...
  screen -S spf -d -m java -Xmx10240m -jar KelinciSPFRunner.jar config-server-berlin-spf
