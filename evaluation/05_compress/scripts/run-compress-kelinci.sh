...
time_bound=60 #18000 #18000 = 5 hours

# number of iterations
number_of_runs=1 #5

# folder with sources
src=/vol/home-vol2/se/nollerya/fuzzing/memoise/issta-experiments/05-compress

# folder for runtime
target=/vol/home-vol2/se/nollerya/fuzzing/experiments/05-compress-kelinci

# kelinci=1, kelinci-spf=2
execution_mode=1

# server parameter
server_param="driver.Driver @@"
