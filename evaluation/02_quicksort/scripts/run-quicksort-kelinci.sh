...
# folder with sources
src=/vol/home-vol2/se/nollerya/fuzzing/memoise/issta-experiments/02-quicksort

# folder for runtime
target=/vol/home-vol2/se/nollerya/fuzzing/experiments/02-quicksort-kelinci

# kelinci=1, kelinci-spf=2
execution_mode=1

# server parameter
server_param="QuickSortJDK15 @@"
