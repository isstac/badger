...
# folder for runtime
target=/vol/home-vol2/se/nollerya/fuzzing/experiments/03-regex-5imageextension-kelinci

# kelinci=1, kelinci-spf=2
execution_mode=1

# server parameter
server_param="Regex resources-byte/popular-regexes/5imageextension-byte @@"
