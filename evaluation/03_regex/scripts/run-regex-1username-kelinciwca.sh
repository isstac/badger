...
# folder for runtime
target=/vol/home-vol2/se/nollerya/fuzzing/experiments/03-regex-1username-kelinciwca
...
echo "Running experiments for: Regex fixed regex 1username in mode $execution_mode"
echo ""
